							...
							<div className='flex flex-col justify-between content-stretch mx-4 max-w-2xl'>
								...
								<div className='indent-8'>
									<p className='text-lg'>
										...
										but a Full Stack Developer. As I moved
										forward in my career I was given more
										and more opportunity, and responsiblity,
										to improve. I have worked in a variety
									...
									<p className='text-lg'>
										...
										moments notice. From creating new
										servers and databases, to making
										painless integrated environments for my
								...
								<div className='flex flex-row justify-stretch my-8'>
									<div className='flex flex-1 flex-col items-stretch mx-8'>
										...
										<p className='text-lg my-2'>
											...
											progressed through the company, I
											was given more and more high-profile
											tasks. I redesigned the algorithm
											for mapping GPS coordinates to our
											maps, helped created a
											Selenium-based testing suite,
											created an IOT system for tracking
											moving 911 callers, and founded a
											UI/UX design team. Eventually I was
											given lead of the effort to create a
									...
									<div className='flex flex-1 flex-col items-stretch mx-8'>
										...
										<p className='text-lg my-2'>
											...
											initiatives. The myRutgers portal is
											a comprehensive web and mobile
											platform designed to provide
											students, faculty, and staff with
											easy access to university resources,
											services, and information. Upon
											joining the team, I was given
											position as{' '}
											<b>Lead Mobile Developer</b>, and
											took charge of the initial release
											of the myRutgers mobile app.
											Starting from nothing, it now offers
