					...
					<CardBody className='flex flex-row justify-around content-stretch py-8 px-12 text-left'>
						...
						<div className='flex flex-col justify-between content-stretch mx-4 max-w-2xl'>
							...
							<div className='indent-8'>
								<p className='text-lg'>
									When working in this industry, you have to
									wear a lot of hats. When I began in the
									programming industry I was nothing but a
									Full Stack Developer. As I moved forward in
									my career I was given more and more
									opportunity, and responsiblity, to improve.
									I have worked in a variety of industries and
									have learned a lot along the way. I am
									always looking to learn more and expand my
									skill set.
								</p>
								<Spacer y={3} />
								<p className='text-lg'>
									Today working as a lead Mobile Developer, I
									have to be able to easily step into any of
									these roles at a moments notice. From
									creating new servers and databases, to
									making painless integrated environments for
									my team members to develop in, whatever
									creates the best experience possible is what
									I am doing.
								</p>
							</div>
						</div>
							...
							<div className='flex flex-row justify-stretch my-8'>
								<div className='flex flex-1 flex-col items-stretch mx-8'>
									...
									<p className='text-lg my-2'>
										...
										Solution that exists as both a mobile
										app and a web app. I started at
										911inform as a{' '}
										<b>Full Stack Developer</b>. As I
										progressed through the company, I was
										given more and more high-profile tasks.
										I redesigned the algorithm for mapping
										GPS coordinates to our maps, helped
										created a Selenium-based testing suite,
										created an IOT system for tracking
										moving 911 callers, and founded a UI/UX
										design team. Eventually I was given lead
										of the effort to create a new Mobile
										Application. Nearly one year later, that
								...
								<div className='flex flex-1 flex-col items-stretch mx-8'>
									...
									<p className='text-lg my-2'>
										...
										myRutgers portal is a comprehensive web
										and mobile platform designed to provide
										students, faculty, and staff with easy
										access to university resources,
										services, and information. Upon joining
										the team, I was given position as{' '}
										<b>Lead Mobile Developer</b>, and took
										charge of the initial release of the
										myRutgers mobile app. Starting from
										nothing, it now offers features such as
										course registration, grade tracking,
										campus news, and personalized
										notifications.
									</p>
								</div>
							</div>
						...
						<div className='flex flex-col items-stretch'>
							...
							<div className='flex flex-row justify-between content-center my-8'>
								...
								<div className='w-2/3 flex flex-row items-center'>
									<p>
										I love Flutter it's the dirty best. It's
										so good you should use it.
									</p>
								</div>
							</div>
							<div className='flex flex-row justify-between content-center my-8'>
