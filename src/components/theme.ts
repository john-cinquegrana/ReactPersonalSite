...
type MaterialColorPaletteMap = {
	[
		key: 'primary' | 'secondary' | 'tertiary' | 'error' | string
 ...
 * component styling.
 */
function themeFromMaterialColors(
...
export const lightTheme = themeFromMaterialColors(
	themeSource.schemes.light,
	themeSource.palettes,
);

// Create a light theme with medium contrast that will be used for the application
export const lightMediumContrastTheme = themeFromMaterialColors(
	themeSource.schemes['light-medium-contrast'],
	themeSource.palettes,
);

// Create the dark theme that will be used for the application
export const darkTheme = themeFromMaterialColors(
	themeSource.schemes.dark,
	themeSource.palettes,
);
